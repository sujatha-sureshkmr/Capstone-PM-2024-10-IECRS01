...
def extract_text_and_images(docx_path):
    ...
    docx2txt.process('Formatted_UNIT_DISASSEMBLY_AND_ASSEMBLY.docx', 'img_folder/')
...
#main
docx_path = "Formatted_UNIT_DISASSEMBLY_AND_ASSEMBLY.docx"
headers, content, df = extract_text_and_images(docx_path)
